...
const Card = ({ bookmark }: { bookmark: Bookmark }) => {
  return (
    <div
      key={bookmark.id}
      className="group border border-gray-100 p-3 mx-2 transition-all duration-150 east-in-out hover:border-l-2 hover:border-l-indigo-500 hover:bg-indigo-50/30 hover:translate-x-0.5"
    >
      <div className="flex justify-between">
        ...
        <div className="flex flex-col space-y-1.5 opacity-0 group-hover:opacity-100">
